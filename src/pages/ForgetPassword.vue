<template>
    <div id='login'>
        ...
        <div class='subBTN'>
            <button type='button' :class='{blueBTN:colorBTN}' @click='tosub'>确认并登录</button>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    watch: {
        telval: function() {
            ...
            this.colorBTN = (this.telval.length > 6 && this.codeval.length) > 0 ? true : false
        },
        codeval: function() {
