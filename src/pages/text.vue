<template>
  <div class="doc" v-bind:class="{mb20:submitSign}">
    <img src="https://sf-static.b0.upaiyun.com/v-57e4f057/global/img/user-64.png" class = "imgh"  v-touch:pinch="scaling($event)" v-touch:pinchstart="scaling($event)" :style="{height:height+'px',width:width+'px',top:top+'px',left:left+'px'}"
