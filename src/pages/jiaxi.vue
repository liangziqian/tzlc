<template>
  <div>
    ...
    <div class='hongbaodetail cf' v-for='(h,index) in hongbaolist'>
      ...
      <div class="shiyong" v-show="h.status==0">立即使用 ></div>
    ...
    <transition enter-active-class='animated bounceIn' leave-active-class='animated bounceOut'>
      <div class='pop' v-show='popflag'>
        <div class='popTitle'>
          <span v-show='activeIndex==0'>加息券说明</span>
          <span v-show='activeIndex==1'>红包说明</span>
          <i @click='popChange'></i>
        </div>
...
<style lang='less' scoped>
  ...
  .hongbaodetail {
    ...
    .hongbaoNumber {
      ...
      i{
        ...
        margin-left: .2rem;
        height:.5rem;
        background: url('../assets/jiaxishouyi.png') no-repeat 50% 50%;;
      }
    }
    .hongbaoNotice {
      width: 100%;
  ...
  .canUse {
    background: url('../assets/jiaxiCanUseBG.png') no-repeat 50% top;
    background-size: 100%;
  }
  .noUse{
